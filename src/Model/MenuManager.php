...
class MenuManager extends Model {
    ...
    public function menu_generate_html($menu = [], $config = [], $level = 1){
        /**
        ...
        if(!empty($menu['children'])){
            foreach($menu['children'] as $child){
                ...
                if(!empty($child['divider'])){
                    ...
                    // <a>
                    $href = (!empty($child['uri']) ? ' href="' . $child['uri'] . '"' : (!empty($child['base_uri']) ? ' href="'.$child['base_uri'].'"' : ' href="#"'));
                    ...
                    if(!empty($child['children'])){
                        ...
                        $html .= $this->menu_generate_html($child, $config, $level + 1);
                    }
